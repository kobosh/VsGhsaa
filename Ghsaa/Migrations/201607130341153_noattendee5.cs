namespace Ghsaa.Migrations
{
    ...
    public partial class noattendee5 : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.MyUserProfiles", t => t.userProfile_Id)
        ...
        {
            DropForeignKey("dbo.AspNetUsers", "userProfile_Id", "dbo.MyUserProfiles");
